...
export default function AISuggestionModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogContent
        className={cn(
          'rounded-[6px] bg-card text-foreground p-5 sm:p-6 border border-border max-w-[95vw] w-full sm:max-w-lg [&>button]:hidden'
        )}
      >
        <DialogHeader>
        ...
        {!useTitleCategory && (
          <Input
            className="text-sm mb-3 focus-visible:outline-none focus-visible:ring-0 focus-visible:border-border"
